...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-0 h-auto md:h-32 py-2 md:py-0">
        <a href="/" className="flex items-center py-2 md:py-0 md:h-80 md:-my-32">
          <Image
            src="/logo-mark.png"
        ...
        <nav className="flex flex-wrap justify-center items-center gap-x-5 gap-y-2 md:gap-6 text-sm md:text-base pb-2 md:pb-0">
