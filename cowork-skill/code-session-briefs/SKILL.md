...
- Diagnostic follow-up emails: a 16 email sequence (instant report email plus five emails over eleven days in three variants, branched on the student's recommended route) is written in the repo at content/email-sequences/revision-diagnostic/, with the MailerLite build guide and deliverability checklist.
