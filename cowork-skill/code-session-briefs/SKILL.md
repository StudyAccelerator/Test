...
- Free tools: the Revision Diagnostic at /revision-diagnostic is now the flagship lead magnet (built 11 July, on a review branch until Waleed merges it). 20 questions, about 4 minutes: students get a revision profile (The Grinder, The Perfectionist, The Crammer, The Re-Learner, The Scholar, The Comfort Reviser, The Optimiser), five system scores, a wasted-hours estimate, a 7 day plan, and a personalised route into the right paid programme. Email is required before the report shows, and every completion writes 13 data points into MailerLite (group "Revision Diagnostic") so students can be segmented by bottleneck, grades, subjects and recommended route. The Revision Tracker at /revision-tracker remains the planning tool; the two cross-link.
