...
- Diagnostic follow-up emails: a 16 email sequence (instant report email plus five emails over eleven days in three variants, branched on the student's recommended route) is fully built in MailerLite as four automations with all copy loaded. As of the evening of 12 July the instant report email (E0) and the Summer Accelerator route are switched on; the Study System and Subject Accelerator routes remain off pending Waleed's review. Source copy lives in the repo at content/email-sequences/revision-diagnostic/.
