...
## Business facts for your planning (snapshot date: 12 July 2026)
...
- Free tools: the Revision Diagnostic at /revision-diagnostic is now the flagship lead magnet (built 11 July, live in production from 12 July). 20 questions, about 4 minutes: students get a revision profile (The Grinder, The Perfectionist, The Crammer, The Re-Learner, The Scholar, The Comfort Reviser, The Optimiser), five system scores, a wasted-hours estimate, a 7 day plan, and a personalised route into the right paid programme. Email is required before the report shows, and every completion writes 13 data points into MailerLite (group "Revision Diagnostic") so students can be segmented by bottleneck, grades, subjects and recommended route. The Revision Tracker at /revision-tracker remains the planning tool; the two cross-link.
- Lead magnet pipeline: a scoped roadmap for the next free tools lives in the repo at content/lead-magnet-roadmap.md. Order: Results Day Rescue (before 14 August), Parent Diagnostic (late August, Facebook channel), Topic Audit for Biology and Chemistry (September), Mock Result Debrief (November), diagnostic retake loop (January).
- Diagnostic follow-up emails: a 16 email sequence (instant report email plus five emails over eleven days in three variants, branched on the student's recommended route) is written and waiting for Waleed's approval in the repo at content/email-sequences/revision-diagnostic/, with the MailerLite build guide and deliverability checklist. It is not switched on until he reviews it and authenticates the sending domain in MailerLite.
