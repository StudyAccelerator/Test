...
- Stripe is now connected. Lifetime sales are 18 payments, all between 20 February and 6 May 2026, £5,573 net after refunds, and zero sales at any current site price; sales stopped the day the emails stopped. This confirms the audit's diagnosis that the business stopped selling while it built.
