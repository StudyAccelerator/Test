    ...
    <main>
      ...
      <header className="bg-brand-cream text-brand-purple py-0 sticky top-0 z-50 shadow-md border-b-4 border-brand-gold">
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-0">
          ...
          <nav className="flex flex-wrap justify-center gap-6 text-sm md:text-base py-0">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="overflow-x-auto bg-white rounded-lg shadow-md mb-16">
            <table className="w-full table-fixed">
              <thead>
                <tr>
                  <th className="bg-brand-purple text-brand-cream p-3 text-left w-1/4"></th>
                  <th className="bg-brand-purple text-brand-cream p-3 text-left font-semibold w-1/4">Study Series</th>
                  <th className="bg-brand-purple text-brand-cream p-3 text-left font-semibold w-1/4">Study Accelerator</th>
                  <th className="bg-brand-purple text-brand-cream p-3 text-left font-semibold w-1/4">Study System</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-brand-cream-dark">
                  <td className="p-3 font-semibold text-brand-purple">Price</td>
                  <td className="p-3"><span className="text-xl font-bold text-brand-gold">£119</span></td>
                  <td className="p-3"><span className="text-xl font-bold text-brand-gold">£499</span></td>
                  <td className="p-3"><span className="text-xl font-bold text-brand-gold">From £2,000/yr</span></td>
                </tr>
                <tr className="border-b border-brand-cream-dark">
                  <td className="p-3 font-semibold text-brand-purple">Format</td>
                  <td className="p-3">4 live group sessions</td>
                  <td className="p-3">Three Months of Application-Focused Support</td>
                  <td className="p-3">Complete 1:1 programme</td>
                </tr>
                <tr className="border-b border-brand-cream-dark">
                  <td className="p-3 font-semibold text-brand-purple">Live Sessions</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> 4 sessions</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> 4 sessions</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> Weekly 1:1 calls</td>
                </tr>
                <tr className="border-b border-brand-cream-dark">
                  <td className="p-3 font-semibold text-brand-purple">Group Q&amp;A</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> Fortnightly</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> Fortnightly</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> Ongoing</td>
                </tr>
                <tr className="border-b border-brand-cream-dark">
                  <td className="p-3 font-semibold text-brand-purple">1:1 Coaching</td>
                  <td className="p-3"></td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> Coaching community access</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> 24/7 Access to Dr Waleed</td>
                </tr>
                <tr className="border-b border-brand-cream-dark">
                  <td className="p-3 font-semibold text-brand-purple">Personal Plan</td>
                  <td className="p-3"></td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> Templates & deep dives</td>
                  <td className="p-3"><span className="text-green-700 font-bold">✓</span> Fully customised</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold text-brand-purple">Best For</td>
                  <td className="p-3">Getting the core system</td>
                  <td className="p-3">Extra support &amp; accountability</td>
                  <td className="p-3">Complete transformation</td>
                </tr>
              </tbody>
            </table>
          </div>
