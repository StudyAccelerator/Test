...
export const metadata = {
  ...
  description: 'A 6-week live A-Level summer course for Year 12 students going into Year 13. Master the high-yield topics that decide your predicted grades. Biology, Chemistry, Maths and Physics. Starts 22nd August.',
  ...
  openGraph: {
    ...
    title: 'A-Level Summer Accelerator | Get Ahead for Year 13',
    description:
      'A 6-week live A-Level summer course for Year 12 students going into Year 13. Master the high-yield topics that decide your predicted grades. Starts 22nd August.',
...
export default function SummerAccelerators() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "The next cohort starts Saturday 22nd August. It runs for six weeks, with two live sessions a week, two hours each. That's 24 hours of live teaching. Exact session times are confirmed when you book.",
    },
    {
  ...
  return (
    <main>
        ...
        <section className="py-6 px-4 bg-brand-purple border-y-2 border-brand-gold/50">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-base md:text-lg text-brand-cream font-semibold">
              ⏳ The next cohort starts <span className="text-brand-gold">Saturday 22nd August</span> with limited spaces. Secure your place now!
            </p>
          </div>
        </section>
      </ScrollFade>
        ...
        <section id="pricing" className="py-20 px-4 bg-brand-purple">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-lg text-brand-cream opacity-80 mb-10 max-w-2xl mx-auto">
              The next cohort starts Saturday 22nd August. Session times never overlap, so you can take all four subjects and still attend every session live.
            </p>
      ...
      <div className="fixed bottom-0 inset-x-0 z-40 md:hidden bg-brand-purple border-t-2 border-brand-gold px-4 py-2.5 flex items-center justify-between gap-3">
        <span className="text-brand-cream text-sm font-medium leading-snug">Cohort starts 22nd August</span>
        <a
          href="#pricing"
