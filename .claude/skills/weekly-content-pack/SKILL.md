...
- **LinkedIn, ONE post EVERY day (Mon to Sun) at 4:30pm UK** (Waleed's standing instruction, 15 July 2026): weekly mix of 2 to 3 story/confession, 3 to 4 value (at least one document carousel, 8 to 9 slides), exactly 1 lead-magnet/harvest post, and lighter reflective posts at the weekend. The week should be one argument told from seven angles, each post standing alone. Hooks under 12 words, one sentence per line, specific numbers over adjectives, zero hashtags, a genuine question or promise-to-reply as the close. Never two posts in one day.
- **Facebook, ONE post EVERY day** (mostly 9:30am, with one or two evening slots as tests): weekly mix of one saveable script/checklist post, one system explainer, one tool/offer post with the parent framing (visibility without nagging), one trust/founder post, plus empathy/story and practical-tip posts to fill the week. Under 130 words, first sentence names the parent's situation, genuine questions only (share-bait phrasing is demoted), boost the week's proven winner £3 to £5 a day.
