...
- **LinkedIn, 5 posts Mon to Fri at 4:30pm UK:** 2 story/confession, 2 value (one as a document carousel, 8 to 9 slides), 1 lead-magnet/harvest post. The week should be one argument told from five angles, each post standing alone. Hooks under 12 words, one sentence per line, specific numbers over adjectives, zero hashtags, a genuine question or promise-to-reply as the close. At most ONE harvest mechanic per week.
- **Facebook, 4 posts (Mon evening, Wed morning, Fri morning, Sun evening):** one saveable script/checklist post, one system explainer, one tool/offer post with the parent framing (visibility without nagging), one trust/founder post. Under 130 words, first sentence names the parent's situation, genuine questions only (share-bait phrasing is demoted), boost the week's proven winner £3 to £5 a day.
