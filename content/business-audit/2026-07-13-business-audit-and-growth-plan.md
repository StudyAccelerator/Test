...
4. **Your live sales page says the cohort starts Saturday 25 July.** Your brief to me says the Summer Accelerator launches early August. One of those is wrong, and the difference is your entire selling window. As published, you have 12 days. *[Resolved 15 July 2026: Waleed moved the cohort start to Saturday 8 August 2026. The site, diagnostic routing card, newsletter drafts and content packs now say 8 August, which extends the selling window by two weeks. Read every 25-July reference below with that in mind; the play mechanics stand, the deadline moved. **The same day he moved both September cohorts to clear the summer run: Subject Accelerator to Sunday 13 September (from the 6th) and Study System to Wednesday 16 September (from the 9th).** The Summer Accelerator's six weeks from 8 August end Saturday 12 September, so the Subject cohort now starts the day after it finishes and no student is asked to buy two overlapping programmes. Every 6-September and 9-September reference below predates that decision; the calendar moved, the analysis stands.]*
...
2. **Stripe: ANSWERED, Stripe now connected.** Live account history: 18 successful payments, all between 20 February and 6 May 2026, gross £6,443 minus £870 in partial refunds, so £5,573 net lifetime before fees. Prices that sold: £479 seven times, £239 five times, £289 twice, then £429, £399, £300 and £189 once each, all from the February to May workshop funnel. No current site price point (the £289 to £849 summer tiers, the £339 to £849 subject tiers, the £119 to £2,000 system tiers) has ever taken a payment, and the Summer Accelerator page has sold zero places. The last sale was 6 May, the day of the last email broadcast. For an ongoing feed, add a read-only restricted `STRIPE_KEY` to `dashboard/.env` and the HQ dashboard tracks it. Full detail in the change plan alongside this document.
