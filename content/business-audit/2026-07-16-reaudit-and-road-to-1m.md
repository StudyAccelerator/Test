...
Where a plan needs a number that does not exist, it says so and asks you for it. Every calculation is labelled as arithmetic. There are no projections, no assumed conversion rates, and no invented figures anywhere in this document.

## 1. The verdict

**The 13 July audit said: the machine is built, turn it on. Three days later the machine is bigger and it is still off.**

Since that audit, 77 commits have shipped: six new blog articles (11 to 17), a 22-post content pack, a Facebook ads runbook with rendered creatives, a Reddit plan, Facebook groups research plus an own-group launch plan, the diagnostic's parent fork, seven newsletter issues loaded into MailerLite as ready drafts, and the HQ dashboard became a phone app. That is a genuinely impressive build rate.

And: the live account shows nothing has been sent since 6 May. Not the re-opening email. Not a Sunday Session (the welcome automation is switched off and SS1 sits unscheduled three days before its send date). Nothing is queued. The newest subscriber in the entire account joined 6 June. The last sale was 6 May, the same day as the last broadcast.
...
| Play 3: parent channel | Real movement: groups activity started, own-group launch planned, ads runbook and three creatives built, GA4 and Meta pixel verified live in production HTML. Legal pages parked on your details, which blocks any paid spend. | Best progress of the five |
...
| Hygiene batch | Largely done and verified live today: og:image, blog CTA default, title dedupe, British spelling, analytics. Still open: MailerLite key in the client bundle, stale remote branches, the lead-magnet roadmap's wrong weekday. | Executed well |
...
1. **The list.** 444 active subscribers whose 19 lifetime broadcasts opened at 46 to 84 percent. Every pound the business has ever made arrived while this list was being emailed. It is the single proven asset.
...
3. **The diagnostic.** Still the only assessment-style capture tool in the nine-competitor set, now with the student/parent fork and parent-voiced automations. Two students and one parent have been through it. It is a loaded weapon that has never been aimed at traffic.
4. **The content estate.** 17 articles, 17 backlink twins, a 22-post pack for this exact fortnight, 16 student and 13 parent sequence emails, 7 newsletter issues loaded as drafts. Months of distribution ammunition already written and mostly already approved in shape.
5. **The wiring.** GA4 and the Meta pixel verified in the live HTML today, lead events on all four capture forms, og:image live, clean funnel paths, 14 automations on. When traffic finally arrives, it will be measured and followed up automatically.
...
8. **The delivery design already scales past you.** Your own summer page says specialist tutors teach the subject sessions and you teach the final sessions. That choice, tutors delivering while you own the method and the brand, is exactly the shape the £1 million evidence points at. You made it instinctively; keep it.
...
4. **The business has no size.** No capacity number, no group-size cap, no session length for the £499 tier, no tutor cost, and no honest weekly-hours figure exist anywhere in the repo (the 13 July audit asked; ask 4 is still unanswered). Without those five numbers, nobody, including you, can compute what a full cohort is worth or which £1 million shape is possible. Thirty minutes with a notepad closes this.
5. **Sales history is unexamined.** 4 of your 18 payments were later half-refunded, £870 of £6,443 gross, about 13.5 percent returned (arithmetic on the recorded Stripe figures). Why? Wrong students, wrong promise, wrong format? Whoever those four people are, their reason is the cheapest product research you will ever get. Similarly, ask 3 (what did the 8 Buyers actually buy?) is still open.
6. **A public price promise is live with nothing behind it.** The summer page still tells every visitor the September cohorts open at a higher price. Either the September pages honour that in writing, or the line comes down. A screenshot of a broken price promise in a parents' Facebook group would cost more than the line ever earned.
7. **Scope creep against your own plan.** The 13 July do-not-do list said no new articles and no new dashboard features in July. Since then: six articles, six twins, and the HQ became a phone app with a home-screen widget. Each is good work. Together they are 77 commits of comfortable building in the exact window the audit said pays selling at a multiple of building.
8. **The two-numbers problem.** Marketing says 1,000+ students worked with; Stripe says 18 payments ever. Both can be true (free workshops, lectures, the tutoring years). But the roadmap must be built from 18, and you should hold the 1,000+ claim to the "worked with" wording it is approved for, nothing stronger, until August results data arrives.
...
| MyTutor | 1:1 marketplace plus schools contracts | £17.5m (FY2024), £23.2m (FY2023), filed | Operating LOSS £5.0m (FY2024); £36.4m accumulated deficit; sold to IXL May 2025 | 192 avg (2024) |
...
3. **The marketplace shape loses money at 10 to 20 times your target.** MyTutor never filed a profit at £17m to £27m revenue. Volume 1:1 is a treadmill; you already know this, it is in your own sales copy.
4. **Scale for the winning shape, as arithmetic on their filings:** £1.36m at their roughly £675 mid ticket is about 2,000 course places a year, around 40 a week across a year, delivered by contracted tutors in classes averaging 5, coordinated by about 13 people. Hold that picture; it is what £1m+ physically looks like in your market.
...
2. **£1 million is a volume business or a high-ticket business, and your published ladder can grow both ways.** Roughly 2,000 places at a £500 average (the Justin Craig shape, multi-cohort, year-round, tutor-delivered), or 500 to 650 families a year at £1,500 to £2,000 (an annual programme; for reference, Up Learn's published price is £319.99 to £419.99 per subject per year and Justin Craig's summer school runs to £1,595, so four-figure annual tickets are normal in this market), or a blend.
3. **Either way, it is not a solo teaching diary.** There is no version of the table a single person teaches alone. Your summer page already made the right move (specialist tutors deliver, you direct). The £1 million question is never "can I teach more hours"; it is "can I fill classes and staff them".
...
## 7. The road: five stages, each with a gate

No stage has a date attached to its revenue, because dated revenue targets from a base of zero current sales would be invented numbers. Each stage instead has a gate: hard evidence that the stage's question is answered. You move when the gate opens, not when the calendar says so.
...
1. Tonight or tomorrow: schedule SS1 (drafted, loaded, dated Sunday 19 July) and switch its welcome automation on. The "one email a week" promise your own sequences make starts being true.
2. This week: the re-opening broadcast to all 444. Where you have been, what you built for them (the diagnostic), and one date that matters (see 3). I can draft it the moment you say yes.
3. Name the successor live event and date it in the week of 27 July to 3 August. The mechanic that produced every sale you have ever made was: broadcast, live teaching session, follow-up arc, offer. Rebuild it around the diagnostic ("bring your diagnostic report; I will show you what it means for your summer") with the 8 August cohort as the offer. Your February and May follow-up templates hit 47 to 84 percent opens; clone them.
4. Post the pack daily (it is written through 26 July), launch the parents' group per the own-group roadmap, keep the groups activity going.
5. Answer the five size numbers (section 9). Thirty minutes.
6. Merge the stranded partnership branch and send the PMT email; September inventory gets committed in July.

**The gate:** first Stripe payments at current prices before 8 August, plus a capacity number you actually believe. If the cohort sells zero at £289 to £849 after a real send-and-event cycle, that is not failure, it is the pricing data the whole roadmap needs, and stage 1 starts with a pricing decision instead.
...
- The parent channel goes properly live: your group, the page cadence, and, once the legal pages are up (they are drafted; they need only your entity details), the first small paid test at the budget you set. The pixel and lead events are already live and verified.
...
- The weekly rhythm becomes the operating system: one approval sitting, one newsletter, daily posts from the pack routine, one live event per selling window.

**The gate:** leads arriving every week from at least two channels you do not pay for (groups, search, Reddit, referrals), plus a second sold cohort, plus results proof live on the pages. You now have a funnel, not a launch.

### Stage 2: Prove the year-round machine. (2027)

**The question:** does the calendar fill itself four times a year, and does delivery scale past your diary?

- The programme calendar becomes annual: autumn 12-week cohorts, a January mocks-response cycle, Easter crash courses (PMT sells these at £95 to £345; Justin Craig at £250 to £775; the market slot is proven), the summer accelerator, results week. Every cycle reuses the same mechanic.
- The tutor bench becomes real: named specialists with agreed economics delivering the subject teaching across cohorts, you teaching the system layer and quality-controlling everything. This is your summer page's design, made permanent.
...
### Stage 3: Choose the £1 million shape and staff it. (2027 to 2029)

**The question:** which verified shape carries the last multiple?

- **Shape A, the Justin Craig clone:** multi-cohort, multi-level (A-level plus GCSE feeder), year-round small-group courses, about 2,000 places a year at about a £500 average, a tutor bench of subject specialists, and a core team approaching ten. Verified profitable at £1.36m with 44 percent gross margin.
- **Shape B, the premium annual:** 500 to 650 families a year in a £1,500 to £2,000 annual programme (subjects plus system plus mentorship-lite), fewer, deeper relationships, results proof doing the selling. No direct filed comparator at exactly this shape, so treat it as the riskier, higher-margin variant and pilot it inside stage 2 before betting on it.
...
**A structural note on all three shapes:** every one runs on the same four assets you already have in v1 today: the doctor brand, the diagnostic funnel, the method layer, and a tutor-delivered classroom. Nothing in the £1m picture requires an asset you have not started. What it requires is each stage's gate, passed in order, and none of them can be passed at a keyboard.

## 8. Keep, double down, drop

**Double down:** the list and the weekly send; the live-event mechanic under a new name; the diagnostic as the front door of everything; the parents' group launch this weekend and the groups playbook; the tutor-delivered classroom design; results-week ownership; the HQ dashboard as-is (it is done; use it, stop extending it).

**Keep, unchanged:** the honesty rule; the voice rules; the site (it is finished; only the price-promise line needs a decision); the automations; the analytics wiring; the newsletter cadence once started; the partnership process (send PMT, then two more).
...
- Delete or archive `content/week-1-optimized.md`: its run window ended today, it is superseded by the pack, and it still contains a workshop lead-magnet post that contradicts the retirement. (Awaiting your call from the previous session; my recommendation is delete.)
...
2. **Capacity:** the group size you can deliver well per class, and the cohort cap you would actually enforce.
...
4. **Tutor economics:** who the summer "expert tutors" are, what they cost per hour or per cohort, and whether they are confirmed for 8 August.
...
8. **Legal entity details** for the drafted privacy and terms pages: this is the only blocker on the ads lane.
9. **The successor live event:** its name and its date. I can build everything else around it.

## 10. What I could not assess, and why

- **Site traffic.** GA4 went live around 14 July and this session has no reporting access; Ahrefs' paid endpoints and its Search Console tools refused ("Insufficient plan"). So I cannot tell you visits, sources or conversion rates. The wiring to answer this next time is live and verified.
...
- **Whether the four diagnostic automations' emails render correctly end to end.** Structure verified (14 on, step counts); content spot-checks were done in previous sessions via preview URLs, not repeated today.

## 11. If you take one page from this document

The 13 July audit ended: "The machine is good. Turn it on." That sentence survives this reaudit completely intact, with three days more evidence behind it and one addition:

**£1 million is not blocked by anything you can build. It is blocked, today, by two clicks (schedule SS1, approve the re-opening email), one calendar entry (the live event), and five numbers only you know. Everything else in this plan follows from those, in order, through gates that are passed by selling.**
