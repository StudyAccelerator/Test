...
- **Facts to re-check whenever an issue mentions them:** results day (Thu 13 Aug 2026, 8am), September cohort (starts Sunday 6th September; Maths Sat 1 to 3pm, Biology Sun 10am to 12pm, Chemistry Sun 1 to 3pm), Summer Accelerator (starts Saturday 8th August 2026, six weeks, first session risk-free; date moved from 25 July on 15 July), the diagnostic's own claim ("20 questions. About 4 minutes."), and the UCAS phone number in SS4/SSX. The workshop page still shows "Saturday 2nd May", so no issue doors to `/workshop/` until that page is updated.
