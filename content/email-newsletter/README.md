...
- **Plain spoken register (Waleed's standing feedback, 9 Aug 2026).** Write like Waleed talks, at roughly a Year 5 reading ease: short sentences, everyday words, one idea at a time. No stacked metaphors or writerly aphorisms ("a bad-news morning feels radioactive" was his named example of what to avoid; "marked meanly", "Tier 1 in fancy dress" and "the discomfort is where the marks are made" were the same problem). Established medical framing (high-yield/low-yield, triage, diagnose before you treat) stays, in plain wording.
- **No "nothing for sale" style disclaimers.** Never write lines like "there's nothing for sale at the end of this": Waleed's call (9 Aug) is that they undercut authority by implying selling is the norm. A no-offer week just says what it does ("Not this week. One thing instead: ...") without flagging the absence.
...
- **Facts to re-check whenever an issue mentions them:** results day (Thu 13 Aug 2026, 8am), September cohort (starts Sunday 6th September; Maths Sat 1 to 3pm, Biology Sun 10am to 12pm, Chemistry Sun 1 to 3pm), Summer Accelerator (started Saturday 25th July, six weeks, first session risk-free), the diagnostic's own claim ("20 questions. About 4 minutes."), and the UCAS phone number in SS4/SSX. The workshop page still shows "Saturday 2nd May", so no issue doors to `/workshop/` until that page is updated.
...
- **SS1 sent.** The launch issue went out Sunday 2 August at 18:20 UK to 429 recipients (campaign `194711467593827416`, kept for its stats; never delete a sent campaign). The 5pm slot was missed on launch day because the review round ran long; from SS2 the drafts schedule at 17:00 exactly.
- The six remaining issues are loaded as **complete draft campaigns**, rebuilt 9 August with Waleed's three review notes applied: (1) every issue ends in his **verbatim builder-campaign signature** (80px round photo, auto height so it never distorts, "Kind regards / Dr Waleed Ahmad / Founder of A-Level Accelerators / email", headshot `account_image/2113061/3SoYgyuLfUdmX53Lnw82S2YV4c6PnZsQch9dP7T5.jpg`); (2) the "nothing for sale" disclaimers were removed from SS2; (3) a whole-run humanising pass to the plain spoken register (see content rules above). Current IDs: SS2 playbook `195328030302799442`, SSX special `195328083586189203`, SS3 doctor `195328137428469152`, SS4 prediction `195328191590565359`, SS5 backwards `195328241445111635`, SS6 ugly notes `195328291037512997`. (IDs change whenever copy changes because campaigns must be deleted and recreated, see the gotcha below.) Each has subject, sender ("Dr Waleed | A-Level Accelerators", waleed@alevelaccelerators.com), preheader (hidden div in the HTML) and the ten-group send list (~428 recipients). None is scheduled: Waleed reviews and schedules each, which is the approval gate.
...
- **Status (15 July):** the automation is **built and left inactive**, ID `193069572102817552` (trigger = joins Sunday Session, subject "Welcome to the Sunday Session"). Passing the full HTML to `create_automation`'s `email_content` was **echoed back but not applied**: the response still returned `emails_need_design: 1` and a "Design email content in visual editor" next step. This is the empirical confirmation that automation email design is a MailerLite product wall, not a permission or plan gate, no API path sets it. Waleed opens the automation, applies the design (paste `welcome-ss1-evergreen.html`), then activates. Activation is deliberately left to him.
