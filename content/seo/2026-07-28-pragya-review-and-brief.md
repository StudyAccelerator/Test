...
September pack handed to Waleed 21 August (A-Level-Accelerators-September-Article-Pack.pdf, built from the backlink twins): the predicted-grades article (money anchor how-to-improve-predicted-grades, with a do-not-duplicate warning since she already syndicated it to Medium, Blogspot, WordPress and Notion in early August, fresh sites only), plus the choose-a-tutor and one-to-one-worth-it twins, both new to syndication, for the parent buying season. All anchors non-www with trailing slashes; instructions on the pack cover. He attaches it to the 21 August reply.

## Round 8: the monthly rollup, the 31 August weekly and the pages chase (reviewed 5 September)

Backlog covered: the 25 August monthly report, the 31 August weekly report, the updated New Pages doc, and her four chase messages (including the 15 vs 20 hours question, twice).

**The address saga is CLOSED.** VyMaps verified clean on 5 September (page live, no postcode or town anywhere on it), completing the set: ZeeMaps, YPlocal, bizify, VyMaps all clean. She also resumed listings this week as the 21 August reply permitted once VyMaps was fixed, and all 10 new listing and local-work URLs were fetched and scanned on 5 September: none carries the address. The privacy rule finally landed. New listings remain junk-tier for authority (a bookkeeping service, a fire-safety forum, an electronics site) but they are compliant.

**25 August monthly report (146 links):** an August rollup that mostly recounts placements already itemised in the weeklies (the syndication sheet repeats the 10 August blurting set verbatim). One genuinely new category: "Blog post" (5 external posts pointing at the tutoring-cost article). Not double-counted against her going forward, but the monthly is a summary, not new work.

**31 August weekly (83 links): the September pack is IN USE.** All 10 article submissions push the predicted-grades post, and the syndication sheet carries the predicted-grades twin (Behance, WriteUpCafe) and the choose-a-tutor twin (Sutori), plus a new sites.google property. Exactly what the 21 August redirect asked for, in season. Two slips: nine links regressed to the www domain (five social profiles, three bookmarks, one thematic) after the fully clean 18 August week, and the Web 2.0 sheet's target column is empty. New "Blog post" category this week: 6 posts to the year-13 article.

**New Pages doc (2): her pending-pages question, answered in the reply.** The four built pages (contact, pricing, privacy, terms) are ticked. The remaining six: About Us stays a genuine candidate on our own backlog for Waleed's word; Meet Our Team is in progress in-house (the /tutors draft of 27 August awaits Waleed's real bios and photos, noindex until then, never outsourced); Our Results, Success Stories and Reviews stay gated on real results data and real reviews (honesty rule; revisit when Waleed collects August results and Trustpilot reviews); Our Teaching Method stays declined (duplicates /study-systems).

**The hours question (15 to 20 per week): recommendation recorded, stay at 15.** Volume has never been the constraint; the standing gap is quality (still zero placements on real education or parenting sites, the lane the in-house listicle outreach covers). More hours of profile placements is more of what we do not need. Revisit if her mix shifts to editorial placements.

Reply drafted 5 September: both reports acknowledged (pack usage praised), www slippage and the empty target column corrected, address closure confirmed, the six pending pages answered as above, hours held at 15 with the reason, predicted-grades kept as the September priority.

## Round 9: the 8 September weekly and the pending-suggestions loop (reviewed 17 September)

Her 5 September reply accepted every instruction (address closed, www fix, Web 2.0 targets, brief monthlies, 15 hours, quality placements). The 8 September report against those promises, all links fetched or parsed on 17 September:

**Kept:** zero www links anywhere, the first fully clean report two weeks running on domains. The September pack is still in use: all 6 article submissions and the syndication set push the one-to-one-tutoring twin (article 3 of the pack), and the external "Blog post" category (8 posts) targets the bad-year-12-results article, which is well timed for autumn. All 20 new business listing and local-work URLs were fetched and scanned: none carries the address. The privacy rule has now held for two consecutive listing batches.

**Broken:** the Web 2.0 sheet's target column is blank again, all 5 rows, the exact item she promised to fix in writing on 5 September. Business listings ballooned to 15 in one week (venuscoaching, successcenter, letsworkremotely, findabusinesspro filed under united-states/surrey), which is the opposite of the promised quality shift; still zero placements on real education or parenting sites.

**The pending-suggestions loop, closed with a per-file verdict list.** Her 12 and 16 September chases re-shared four files verified identical to versions already evaluated (Meta non-target xlsx still quotes the pre-fix doubled FAQs title; Ahrefs and Non Target Pages match the known 189KB/72KB documents; Schema non-target is the same diagnostic + parents pair). The 17 September reply gives her a definitive per-document status so her records can close: Ahrefs = report, nothing to implement; Meta non-target = closed (our titles kept deliberately); Schema non-target = closed (WebPage schema already in code, Organization downgrade declined); Non Target Pages = closed (FAQ topics adopted in Waleed's voice in earlier batches, heading rewrites declined). Standing instruction added: on-site documents are closed unless based on a fresh crawl finding something genuinely new.

## Round 10: the Detailed Performance Report (reviewed 20 September)
...
**Her recommendations, triaged:** titles/snippets CTR pass on high-impression pages (agree, matches backlog: "a level revision planner" at 706 impressions/1 click and the resit cluster are the targets), contextual CTAs and internal links on the resit/revision articles (agree, ours to do via the optimiser), date/FAQ freshness (agree, standing practice), configure key events (already done), sitemap/canonical review (fine, done monthly). Nothing adopted from her as file uploads, per standing rule 3.

**Next-week direction handed over with materials:** placements switch to the resit article, the site's biggest-impressions asset (19,226 impressions on the post, plus "can you resit a levels in november" at 323 impressions and position 10.4), using the newly built single-article pack A-Level-Accelerators-Resit-Season-Article.pdf (twin of the resitting-a-levels post, never syndicated before). Predicted grades stays the secondary target. Same rules ride on the pack cover.

## Round 11: the 21 September weekly (reviewed 24 September)

41 links, and the format discipline is now simply holding: every link non-www with trailing slashes, every target column filled on every sheet, and all 8 new business listing and local-work pages fetched and scanned clean of the address (third consecutive clean batch).

**The mix:** subject-accelerators is the week's main target (18 of 41 links across profiles, bookmarks and thematics), local work and listings total 8 (above the two-a-week cap she agreed on 17 September; mild flag), forum profiles 4, and the external blog-post lane (9 posts) points at the missed-university-offer article, which is out of season now that results week is six weeks gone. No article submission or syndication sheets at all this week, consistent with the resit pack and diagnostic-anchor instructions (drafted 20 September) not yet having reached her when the week was worked. Still zero education or parenting placements.

**Reply (24 September):** praise the format streak and clean listings, restate the cap, redirect the blog-post lane off the missed-offer article and onto the resit article (pack attached with the reply), introduce the diagnostic anchor share (roughly one in three of the profile/bookmark placements to /revision-diagnostic/), and keep education/parenting placements as the standing quality ask.

## Round 11 addendum, 24 September: the placement-quality reset (Waleed's ruling)

Waleed challenged the resit-article direction before sending the round 11 reply, and he was right. Three things changed, all his call:

**1. Target pages: buyer intent over impressions.** The resit recommendation was traffic-led (biggest impressions, closest to page 1) rather than revenue-led. A resit searcher sits exams in June 2027, is usually out of school and self-funding; the September buyer is a parent of a current Year 12 or 13 acting this term. The resit pack built on 20 September was scrapped (its PDF was never saved and no longer exists). **The September Article Pack already in Waleed's Downloads (predicted grades, choosing a tutor, is-tutoring-worth-it, built 21 August) is the correct set and stays the standing material**, predicted grades first because it is both buyer-intent and already near page 1 (position ~8) while the tutor cluster sits at position 28.

**2. Placement quality is now the whole brief, evidenced.** GA4 traffic acquisition, 28 days to 23 September, 1,548 sessions: Pragya's placement domains that produced any traffic at all were taggedface.com (3 sessions), padlet.com (3), lite.evernote.com (3), intently.co (3) and detroitsportsforum.com (2). Her entire programme is worth roughly 20 to 30 sessions a month, about 1.5% of traffic, from audiences with no relationship to UK A-level buying. Google organic delivered 330 and Waleed's own Facebook posting 68 in the same window. The standing ask is now two genuine placements a week on UK education sites, parenting sites, school or college resource pages or student advice sites, and he would rather receive a report with two links on it than forty.

**3. Waleed added a partnership condition to the reply he sent (24 September):** if education and parenting placements do not start landing, the engagement does not continue. Future rounds judge the report on placement quality first and volume not at all; if two or three weeks pass with none, the live question is whether these hours move to his own outreach (the drafts in `content/seo/2026-08-09-listicle-outreach-drafts.md`, still largely unsent) rather than being rebriefed again.

Also corrected this round: her "no GA4 key-event data" finding was CORRECT and a session wrongly told Waleed otherwise. Key events were marked in GA4 on 24 September (see CLAUDE.md); the reply he sent owns the error.
