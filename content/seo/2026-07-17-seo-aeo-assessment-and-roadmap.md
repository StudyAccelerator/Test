...
| 3 | Freshness and answer pass on /blog/resitting-a-levels/ (dates table for 2026 and 2027, cost table, direct answers to the near-miss cost and date queries) | 357 impressions at position 21; the single biggest near-term traffic win. **24 July: Tutorful and Save My Exams now hold the cost and dates queries (estimate), so the window is closing** | **live 2 August 2026** (dates table, November-series answer, two new FAQs) |
...
| 5 | Freshness pass on predicted-grades and year-12-summer posts (already page 1; push to top 5) | Positions 6 to 7 with real impressions | **live 2 August 2026** |
| 6 | Course + CourseInstance schema on programme pages | Live courses with zero Course markup; rich-result eligibility | **live 2 August 2026** |
...
| 9 | Bing Webmaster Tools verification + sitemap submission | Bing barely indexes the site; Bing feeds ChatGPT and Copilot | **done 28 July**: Waleed entered his password, the site imported from Search Console, verified, and sitemap.xml submitted (Bing shows it processing; data within 48 hours). Weekly runs can now read Bing Webmaster performance too |
| 10 | Trustpilot (or Google Business Profile) decision and first reviews | Review platforms are what AI recommendations cite for "best tutoring" questions | decided 28 July: deferred until results day (13 August); Waleed will ask students for Trustpilot reviews once results are in. Queue the profile setup and the review-ask email for results week |
...
| 17 | dateModified discipline on genuine updates | Waleed decided 28 July: NO visible last-reviewed lines for now (stale dates could put visitors off); honest dateModified bumps in schema and the existing byline "Updated" date continue | standing rule, amended |
...
| 19 | "How much does A-level tutoring cost in 2026?" post with an honest rates table | Tutorful and MyTutor rank with pricing pages; half the near-miss resit queries are cost queries; feeds the same buyers | **live 2 August 2026** (/blog/how-much-does-a-level-tutoring-cost/, reframed 2 Aug on his rule: group prices only ever mean OUR programmes vs one-to-one) |
| 20 | Per-subject tutoring landing pages (Biology, Chemistry, Maths, Physics) | Verified: solo exact-match specialists outrank marketplaces on "[subject] a level tutor"; we route everything to one generic page | **live 2 August 2026** with his feedback round applied (gold H1s, who-teaches wording); Physics page waits for the Physics tutor hire |
...
- 2026-09-17: blog wave 2 (six posts) built on `claude/seo-blog-wave-2` by the blog pipeline, awaiting Waleed's approval. It covers the Biology and Maths halves of backlog 7 (subject revision guides, each linking its subject tutoring page) plus four September-window posts (UCAS personal statement 2027 entry, predicted grades lower than expected, is-my-child-revising-properly, GCSE-to-A-level jump). Fresh SERP re-score the same day: parent revision-check and Year 12 struggle queries are forum-held soft SERPs; "ucas personal statement 2027 entry" is small-blog territory; the existing predicted-grades post was seen ranking about position 7 for "can you challenge predicted grades a level". Chemistry and Physics guides from backlog 7 remain unbuilt. Do not rebuild these six in an optimiser batch.

- 2026-08-02: BATCHES 3 AND 4 DEPLOYED TO PRODUCTION on Waleed's instruction, merged with the meta-ads session's records (their newer as-built file kept). Now live: /contact/, /pricing/ (his H1 and comparison rules applied), /privacy/ and /terms/ in the big-site register, three subject tutoring pages with his feedback round, the tutoring cost post, the resit hub upgrade, FAQ additions, Course schema, the voice sweep, and footer legal links. IndexNow pinged after deploy. Pricing comparison rule now standing: group teaching prices on this site only ever describe OUR programmes (£12 to £14 an hour) against one-to-one at around £50; never quote market rates for other group providers.

- 2026-08-01 (batch 4 built as a draft, Waleed deploys manually): /contact/ (free 30 minute call framing, email with one-working-day reply promise, parent routes, ContactPage and FAQ schema, no address or phone by design) and /pricing/ (every price on one page, per-hour maths, the £50 an hour one-to-one anchor, refund promise, FAQ schema; prices must always match the programme pages, rule in CLAUDE.md). FAQ additions from Pragya's usable topics: materials FAQ on /subject-accelerators/, "What is the Study System?" and "vs a revision timetable" on /study-systems/. Voice sweep on Waleed's instruction caught rule-slippage in the pre-July pages: em dashes, three banned AI-tell words, hyphen ranges and one US spelling, all fixed; the study-systems FAQ accordion was hiding every answer from crawlers (same bug as the faqs page had) and carried a stale "May 6th" cohort date, both fixed. Base folded in batch 3 plus the video-scripts session per his merge instruction. Free calls stated as 30 minutes everywhere, per his correction.

- 2026-07-28 (batch 3 built, awaiting approval): resit hub upgrade (2026 to 2027 dates table, no-November answer, two FAQs), targeted FAQ additions on the two page-1 posts, Course schema on the Summer page, the tutoring cost post (with backlink twin part6.html), and three per-subject tutoring pages (Biology, Chemistry, Maths) on a shared honest template: live small-group framing, never tutor-marketplace framing, subject-specific mark-leak sections, real testimonial quotes, per-subject Course and FAQ schema, footer and llms.txt wiring. Waleed's calls recorded: no visible last-reviewed dates for now; backlink-twin divergence concern resolved (twins are deliberately different rewrites); Physics tutoring page queued until his Physics tutor is secured.

- 2026-07-28 (later): Bing Webmaster Tools done (Google import, verified, sitemap submitted). Trustpilot deferred to results week on Waleed's decision; student reviews planned. The stale workshop.alevelaccelerators.com subdomain (the old February site, served via Cloudflare, still ranking at ~4.6) was killed at the source: its A record deleted from GoDaddy DNS on Waleed's instruction. Two old "signup" A records were noticed in the same DNS zone (legacy funnel host); flagged for Waleed, untouched.
