...
I call this profile The Grinder. It was me at 17.
...
None of these mention hours. That's deliberate. After 1,000+ students, I can tell you effort is almost never the problem. The method is.
...
Teachers write those predictions early in the autumn term of Year 13, and they lean heavily on how a student finished Year 12 and how they start September.

So for a teenager going into Year 13, this summer quietly sets the UCAS options list.

The useful response isn't a summer chained to a desk. It's about two focused hours a day, pointed at the right topics, so they walk into September ahead instead of catching up.

Most Year 12 parents genuinely haven't been told this. It's the single most useful thing I know that almost nobody outside schools knows.

Parents of Year 12s: did anyone ever explain this to you? Genuine question, I'm curious how many families hear it in time.
...
So I built something for exactly this situation. A free 20-question revision check-up. Your child can do it in about 4 minutes. And if they won't, you can fill it in yourself, answering from what you see day to day. There's a parent option built in.

The report shows how their revision scores across five systems, which type of reviser they are, roughly how many hours a week their current method wastes, and the one thing to fix first.

I'm a doctor. This is the "take a history before treating" step that tutoring usually skips.

It's also, honestly, the one useful thing you can do this summer that isn't nagging. You get to see what's actually going on. They get a plan that didn't come from you.

Link's in the first comment. If the report surprises you, message me and I'll happily talk it through. No strings.
...
Because six years ago I was the student. I got the grades and got into medicine, but with a revision method so inefficient I paid for every mark twice over in hours.

Medicine then taught me how learning actually works under pressure: retrieval, spacing, performing on the day. Nobody teaches that at sixth form. I watched hard-working, capable students get outperformed by students who'd simply been shown the system.

That's the gap I work on now. Not re-explaining content. The layer nobody covers: how to revise, how to remember, how to perform in the exam itself.

If your child is heading into Year 13, start with the free tools on the site, they're genuinely free. And if you have questions, message me. I answer everything myself.

**First comment:** The free tools: the 4-minute revision diagnostic https://alevelaccelerators.com/revision-diagnostic and the weekly revision tracker https://alevelaccelerators.com/revision-tracker
...
Hook (also as on-screen text): "Your child's revision has one of seven failure patterns. I can usually spot it in four minutes."

Body: "I'm a doctor, and before we treat anyone we take a history. Nobody does that for revision. So I built a free check-up that does. Twenty questions about how a student actually revises. Not how much, how. It scores the five systems grades are built on, tells you which of seven revision types your child is, and roughly how many hours a week their current method wastes. It was the pattern I lived at 17: hundreds of hours of re-reading that looked like hard work and barely moved my marks."

Close: "It's free, it takes about four minutes, and the link is in the comments. Do it with them, or honestly, do it about them. There's a parent option."

**Caption (Facebook):** The free revision check-up for A-level families. Four minutes, honest answers, and you finally see what's actually going on. Link in the comments.
