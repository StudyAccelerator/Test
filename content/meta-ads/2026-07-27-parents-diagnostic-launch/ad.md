...
**Restructured 1 August 2026 (Waleed's decision after 4 days of data: 1 lead at £39.41, link CTR stuck under 0.8% while the page converted fine):** two campaigns at £10/day each to 7 August. Campaign 1 keeps the face creative with the audience narrowed toward A-level households (parents segments AND A-level/tutoring/UCAS interests via "Narrow audience"); campaign 2 is a duplicate carrying the profiles creative on the original broad-parents audience. The cells differ in two ways (creative and audience), a deliberate pragmatic trade-off at this budget; readouts must remember that. Waleed builds and publishes both himself.

As-built verification (1 August evening): both campaigns Active at £10/day each, campaign 2 ends 7 Aug 23:59 correctly. Campaign 1's published audience came out as ONE OR-list (Test preparation, University and college admission, School/University A-level, Field of study O & A Level, Parents with teenagers 13-17) with no "narrow audience" AND-layer, which includes A-level students themselves and dropped the parents-of-adult-children segment; flagged to Waleed with the exact rebuild steps, his call. Campaign 2 carries the original parent segments but the duplicate reset its age suggestion to 18-65+. Because students completing the student diagnostic fire the same Lead event, every lead on campaign 1 now gets a provenance check in MailerLite (parent group vs student group) before it is counted as a parent lead; the daily monitoring task enforces this.
