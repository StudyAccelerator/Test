...
ROWS = [
    ("01-general", "Is your child studying for", "their A-levels?", "",
     ["marker", "plain", "face"]),
    ("02-y13", "Is your child going into", "Year 13?", "", ["marker", "plain", "face"]),
    ...
    ("05-struggling-chemistry", "Is your child struggling with", "A-level Chemistry?", "",
     ["marker", "plain", "face"]),
    ("06-y12", "Is your child going into", "Year 12?", "", ["marker", "plain", "face"]),
]
def nb(s):
...
FACE_KEEPS_MARK = {"01-general", "02-y13", "03-struggling-maths", "04-struggling-biology", "05-struggling-chemistry", "06-y12"}
