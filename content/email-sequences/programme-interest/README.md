...
Written 27 August 2026. Seven emails, one a day, over 7 days on the new group "Programme interest", fed manually by Waleed whenever someone asks about the programmes (DM, reply, call, CRM): the full picture with prices in plain sight, week one from inside, proof in students' words, the money done openly, and the decision email. Mixed student/parent audience, so the copy stays neutral. Prices must match the live pages (£339/£629/£849, Study Series £119, Top 1% Mentorship £300 a month); cohort START DATES never appear in email copy (evergreen rule, 14 September 2026: dates live on the site only). If the pages change, update these files and re-run the engine the same day. Cadence, build and switch-on: ../README.md.
