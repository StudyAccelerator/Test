# PI4 · The decision, made properly

Send: Day 6
Subject A: {$name}, Making The Decision (Either Way)
Subject B: How To Decide, And What If The Answer Is No
Preheader: How to decide from the diagnosis, the guarantee, and what happens if the answer is no.
Goal: the close. Decision framing without pressure. One CTA: the page. Reply as the release valve.
...
Places are capped because small groups are the whole point. When a subject fills, it fills.
...
That's a fine answer, and it deserves the same care. Run the free plan well, keep the report's advice somewhere you can see it, and reply to tell me what you chose so I'm not left guessing.

Nothing here runs out. The programmes, the free tools and my free strategy call all stay right where they are.

Whatever you choose, choosing this week beats drifting. That's true in revision, and it's true here.
