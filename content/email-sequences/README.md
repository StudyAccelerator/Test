...
6. **Waleed's email style (6 September 2026 pass).** Every email follows `.claude/skills/content-studio/references/email-style-waleed.md`, learned from his own line-by-line rewrite of the day 1 call email: "Hi {$name}," and "Dr Waleed here" on first contact; joined sentences, never punchy fragment pairs; the call is always "a full strategy plan"; free things are rewards for the reader's action ("a reward for completing the diagnostic and taking an active approach to your grades"); qualify by ambition ("students keen to improve their grades"); an ask in return instead of a disclaimer ("all I ask is that you keep me updated on the improvements you see :)"); and a PS on every email that restates the one action with some of his real life in it (on-call, nights, haha). Every defensive line is gone ("no pitch", "who shouldn't join", "keep your money", "I can't show you grade statistics", "I won't pretend", unsubscribe reminders). Proof is stated in his order: "on average, our students jump two grades", real testimonial quotes, then the satisfaction guarantee (first session, money back, no questions asked); the old confidence statistic is retired. His own day 1 email (`revision-diagnostic/01-shared-the-call.md`) is kept verbatim and is the reference; the compliance scanner flags its "when it comes to" by design, and that flag is accepted.
