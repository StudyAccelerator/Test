...
Before you decide anything about {$diag_child_name|default('your child')}'s study method, you deserve to know what evidence sits behind my recommendation. Sorted honestly: what I can show you, and what I can't.

**What I can show you.** The method itself, testing yourself instead of re-reading, returning to material before it fades, isn't mine and isn't new. Retrieval practice and spaced repetition are the most replicated findings in the whole science of learning. I didn't invent the machine, I teach teenagers to actually run it, which turns out to be the hard part.
...
**What I can't show you, yet.** Grade statistics for my own programmes. I won't quote a results number I haven't verified, full stop. Any tutoring company that promises your child a grade has told you something important about itself. I hold myself to the same rule.

**Why this email exists.** Because tomorrow's email lays out the fix itself, and later this week I do the money properly. You should weigh all of it against evidence you've seen sorted honestly, not against marketing.

And the standing offer stands: a free half hour where we look at {$diag_child_name|default('your child')}'s report together and I tell you straight which level of help fits, where "run the free plan and keep your money" is a real answer I give regularly. Reply with a couple of days that suit and we'll find a time.
