...
Subject A: {$name}, The September Decision
Subject B: One Decision Before {$diag_child_name|default('your child')}'s Predicted Grades
Preheader: A new cohort is starting soon. Here's the yes, the no for now, and the call.
...
This is nearly the last email on this from me. Then this series ends and you're back to my regular emails.

The only time-bound fact is this: a new cohort is starting soon, and the exact date is on the page. It runs across the exact weeks when {$diag_child_name|default('your child')}'s teachers decide what their predicted grades will be. Year 13 only has one autumn.
