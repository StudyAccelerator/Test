...
Knowing something and performing with it in an exam are two completely different skills. School teaches the first one for seven hours a day and almost never teaches the second. Marks live in the details: the command word, the exact phrase the mark scheme rewards, the timing, answering the question that was actually asked rather than the one they revised for. That layer can be trained, and right now it hasn't been.
