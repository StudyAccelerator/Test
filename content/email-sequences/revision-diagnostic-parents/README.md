...
Proof, since 6 September 2026 on Waleed's instruction: "on average, our students jump two grades", real testimonial quotes, and the satisfaction guarantee. The old confidence-shift statistic is retired, and no email carries a "we don't promise grades" style line. Prices are stated plainly (£289+ summer, £339 subject, £119/£499 system) and anchored against the real ~£50/hour tutoring average. No countdown-timer urgency: the only deadlines cited are the actual cohort dates (Saturday 8 August, Sunday 13 September). If cohort dates or prices change on the site, these emails must be updated in MailerLite the same day; the repo copy is the source of truth.
