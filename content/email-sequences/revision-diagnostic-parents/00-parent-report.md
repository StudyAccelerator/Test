...
Subject A: {$diag_child_name|default('your child')}'s Diagnostic Report & Next Steps Towards Top Grades
...
Revised: 12 September 2026 by Waleed in the MailerLite builder (subject, the "as a doctor I treat academics" line, "academic journey", the named booking link, the inline PS link); ported back into this file word for word on 13 September, typo "acaademic" corrected.
...
Now, as a doctor I treat academics a lot like healthcare. Just like in healthcare, the diagnosis isn't the only important bit, the management that follows is equally, if not even more important!

So alongside the report, you'll find the option to book a call with me for a completely free academic strategy plan for {$diag_child_name|default('your child')} (as a thank you and reward for taking control of their academic journey!). On the call, I'll highlight exactly the areas that are holding {$diag_child_name|default('them')} back and give you my personal advice on how they can get a huge head start into the year and boost their grades.
