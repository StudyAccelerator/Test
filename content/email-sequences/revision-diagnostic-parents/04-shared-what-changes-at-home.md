...
You probably know the current version. The door is shut. "Have you revised?" sounds like blame, however gently you say it.

Some evenings you can't tell if they're working or struggling, so you hover. The hovering starts an argument, and now everyone's evening is worse and no revision happened anyway.

The worry doesn't stay in their room. It moves into the kitchen, and it sits with you at ten at night after they've gone up.
...
PS: If home feels a long way from the version I described, that's worth half an hour of my time. I'd be happy to build {$diag_child_name|default('your child')}'s plan with you. [Click here to book your free academic strategy call](https://scheduler.zoom.us/dr-waleed-ahmad/academic-strategy-call).
