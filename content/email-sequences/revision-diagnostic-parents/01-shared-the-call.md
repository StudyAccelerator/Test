# P1 · The call offer (shared, loaded into both parent route automations)
...
Dr Waleed here. Yesterday you got {$diag_child_name|default('your child')}'s revision diagnosis, and if you're anything like most parents I speak to, it named something you'd already sensed but couldn't quite pin down.
