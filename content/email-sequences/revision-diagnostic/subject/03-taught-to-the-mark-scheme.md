...
Over the last few emails you've built the drill (timed sections, marked harshly, letters logged) and the dictionary (the phrases your board rewards). Run those for the rest of the term and your W pile shrinks on its own.

Today I want to show you the trained version, because there's a limit to doing this alone. You've likely seen it already: you can't fully mark yourself.

The wording gaps you can see, you fix. But the ones you can't see are the ones that keep costing you. Your version sounds right to you.

Breaking that loop needs a second pair of eyes that knows the scheme inside out. That's what the Subject Accelerator is for.
...
Expect two to three hours of work on your own each week between sessions. And each session is recorded if life gets in the way.

**Why this is the right fit for you**

Your report flagged {$diag_bottleneck|default('Exam Craft')} in {$diag_worry_subject|default('your priority subject')}, with a gap between {$diag_current_grade|default('where you are')} and {$diag_target_grade|default('where you want to be')}.
...
On average, our students jump two grades. And in their own words:
...
One subject is £339 for the full twelve weeks. Two subjects £629, three £849.

For scale, £339 is less than seven hours of 1:1 tutoring at the £50 an hour average. That buys you a whole term of weekly specialist teaching.

And you're covered by our satisfaction guarantee. Join the first session, and if you're not completely satisfied, you get your money back, no questions asked.

**One thing to check**

If your subject isn't Biology, Chemistry or Maths, reply and I'll point you at the right thing. And if you haven't done a single timed section yet, do one this week before you decide. Your letters will tell you a lot.

The dates, times and detail are all here:

[BUTTON: See the Subject Accelerators -> https://alevelaccelerators.com/subject-accelerators/]

Not sure whether your log says K or W? That's what the free academic strategy call is for, and you can [book yours here](https://scheduler.zoom.us/dr-waleed-ahmad/academic-strategy-call).
