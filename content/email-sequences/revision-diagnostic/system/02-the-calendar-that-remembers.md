...
If the honest answer is "hardly any of it", you're normal. Memory fades quickly at first and then more slowly, and a topic you've only touched once is mostly gone within days. That's not a flaw in your brain, it's how every brain works, mine included. The students who seem to remember everything aren't built differently. They just come back to material at the right moments, so it never fully fades.

Here's what this costs you, in your own numbers. You told the diagnostic you study about {$diag_hours_per_week|default('several')} hours a week, and your report estimated that {$diag_low_yield_hours|default('a fair chunk')} of those hours are going into low-yield work. A big part of that waste is one specific loop: you learn a topic, leave it, forget it, then re-learn it from scratch in a panic before a test. Re-learning takes nearly as long as learning did, so you end up paying twice for the same topic. Break that loop and you get those hours back without studying a minute more.

**The rhythm: day 1, day 2, day 5**

Day 1: learn or rebuild the topic properly. That's the blurting protocol from my last email.
...
Forget the four hour marathon. Forty-five focused minutes, most days, beats one big weekly session easily. Partly because the day 2 and day 5 returns need "most days" to exist, and partly because your focus genuinely runs out. Decide the night before exactly which topic and which task you're doing, so you start without negotiating with yourself. Phone in another room before you sit down, not after, because "after" never comes. And when the 45 minutes are up, actually stop. If you don't resent the system, you'll still be running it in October.

If you want the returns and the sessions planned for you around your real week, school, work, sport, all of it, the free Revision Tracker builds the week automatically on exactly this method: https://alevelaccelerators.com/revision-tracker/
