...
Two emails ago you learned the blurting protocol. Last time, the day 1, day 2, day 5 rhythm and the 45 minute session. If you've actually run them this week, you've already felt the odd thing about this method: none of it is hard. There's no genius move in there. It's a pen, a page, and a calendar.

So why isn't everyone doing it?

Because knowing a method and running a method are different problems. Week one runs on novelty. Week three is where it goes quiet: school restarts or the holiday routine wobbles, one day gets missed, the miss becomes a pattern, and by half term the beautiful system is a memory that makes you feel worse. I watched myself do exactly this at 17, twice, with two different "perfect" systems. The failure was never understanding. It was carrying the whole structure on willpower, alone.
