...
Because knowing a method and running one are not the same thing at all.

Week one is easy, because it's new. Week three is where it goes quiet. School gets busy or the routine wobbles, one day gets missed, and the miss becomes a pattern.

By half term the whole thing is just a memory that makes you feel worse.

I did this at 17, twice, with two "perfect" systems. The problem was never knowing the method. It was carrying the whole thing on willpower, alone.

Your report told the same story, by the way. {$diag_bottleneck|default('Your primary leak')} isn't a knowledge gap. It's a how-you-work gap.
...
PS: If your real problem is one science subject's content rather than the method, reply and tell me. Our subject programmes would be the better first step, and I'd rather point you at the right thing.
