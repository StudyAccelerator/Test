...
Send: Day 11
Subject A: show your parents the plan
Subject B: a section for whoever pays for things
...
So today's move: forward this email to a parent, with the section below written for them. It explains what you're doing and why it works, in their language, from me.
...
If it would help to talk through where their revision stands, I'd be happy to build your child's plan with you on a free 30 minute call. [Book a call here](https://scheduler.zoom.us/dr-waleed-ahmad/academic-strategy-call).
